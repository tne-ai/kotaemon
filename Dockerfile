...
# Good practice: avoid cache bloat and pin if you know the version
# Example: RUN pip install --no-cache-dir your-missing-package==1.2.3
RUN pip install --no-cache-dir pylance